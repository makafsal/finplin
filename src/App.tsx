...
function App() {
  ...
  const sortByColumn = (column: string, dir: "asc" | "desc") => {
    const _sortedBudgets = _.orderBy(budgets, [column], dir);
          ...
          <Column lg={8} md={4} sm={2} className="mt-5">
            <div className="filtersHolder">
              ...
              <OverflowMenu renderIcon={Filter} flipped={true}>
                ...
                <OverflowMenuItem
                  itemText="Budget asc"
                  onClick={() => sortByColumn("maxAmount", "asc")}
                />
                <OverflowMenuItem
                  itemText="Budget dec"
                  onClick={() => sortByColumn("maxAmount", "desc")}
                />
                <OverflowMenuItem
                  itemText="Amount asc"
                  onClick={() => sortByColumn("amount", "asc")}
                />
                <OverflowMenuItem
                  itemText="Amount dec"
                  onClick={() => sortByColumn("amount", "desc")}
                />
              </OverflowMenu>
            </div>
          </Column>
